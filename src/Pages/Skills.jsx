    ...
    return (
        ...
        <div className="skills-container">
            ...
            <div className="skills-boxes">
                ...
                <div className="skill-box">
                    <h2>Web Developer</h2>
                    <p>As a <span className='highlighted-text'>web developer,</span> I specialize in building responsive, user-friendly applications for iOS and Android. I leverage the latest technologies to create apps that provide smooth and efficient functionality.</p>
                </div>
                <div className="skill-box">
                    <h2>Mobile App Developer</h2>
                    <p>I am a skilled <span className='highlighted-text'>mobile app developer</span> with experience in building dynamic, responsive websites. I am proficient in modern web technologies, ensuring clean code and seamless functionality across devices and platforms.</p>
                </div>
            </div>
